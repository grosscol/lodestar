...
## Additional resources
  ...
  + [*Overview of unmarked*](https://cran.r-project.org/web/packages/unmarked/vignettes/unmarked.html) vignette by Ian Fiske and Richard Chandler. The official intro guide that I copied some of the early examples from.
